...
class Gufo_v2
{
    ...
    public function test()
    {
        ...
        //осталось каждую позицию проверить на вхождение в массив полов, и если она туда входит - создать ее копию дописав в ее названии Для девочек, а в оригинальной позиции - ДЖля мальчиков.
        $newer_items=null;
