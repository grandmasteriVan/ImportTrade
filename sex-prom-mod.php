...
{    
    ...
    */
    ...
    private function setDescr($item)
    {
        ...
        $const="<p>&nbsp;</p><hr /><p>Секс-шоп SEXisGOOD</p>";
    ...
    public function parseXML()
    {
        ...
        foreach($items as $item)
        {
            ...
            //костюмы
            if ($catId==465||$catId==476||$catId==466||$catId==469||$catId==448||$catId==467||$catId==468||$catId==475||$catId==474||$catId==473||$catId==471||$catId==472||$catId==470)
            {
            ...
            //смазки
            if ($catId==378||$catId==376||$catId==377||$catId==379||$catId==380||$catId==320||$catId==438)
            {
                //echo "нашли позицию с нужным ИД<br>";
            ...
            //возбудители
            if ($catId==367||$catId==368||$catId==382||$catId==375||$catId==366||$catId==383||$catId==482||$catId==433||$catId==432||$catId==431)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //находим имя айтема для поиска вкуса
                $itemName=$this->getItemName($item);
            ...
            //Духи с феромонами
            if ($catId==369||$catId==371||$catId==370)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            if ($catId==373||$catId==374||$catId==437||$catId==439||$catId==440||$catId==436)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            //Секс приколы
            if ($catId==481||$catId==477||$catId==478||$catId==479||$catId==480)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            //белье
            if ($catId==450||$catId==452||$catId==449||$catId==394||$catId==396||$catId==398||$catId==453||$catId==388||$catId==386||$catId==384||$catId==454||$catId==455||$catId==456||$catId==457||$catId==458||$catId==459||$catId==397||$catId==451||$catId==387||$catId==389||$catId==390||$catId==391||$catId==393)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            //мужское белье
            if ($catId==385||$catId==463||$catId==460||$catId==461||$catId==462||$catId==464)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            //BDSM
            if ($catId==404||$catId==406||$catId==403||$catId==399||$catId==400||$catId==401||$catId==402||$catId==405||$catId==407||$catId==408||$catId==409||$catId==410||$catId==411||$catId==412||$catId==400||$catId==444||$catId==414||$catId==415||$catId==416||$catId==441||$catId==442||$catId==445||$catId==446||$catId==443||$catId==447||$catId==395)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $itemName=$this->getItemName($item);
            ...
            //игрушки
            if ($catId==356||$catId==363||$catId==318||$catId==355||$catId==337||$catId==330||$catId==420||$catId==317||$catId==332||$catId==347||$catId==424||$catId==352||$catId==315||$catId==361||$catId==357||$catId==345||$catId==340||$catId==344||$catId==305||$catId==304||$catId==417||$catId==418||$catId==419||$catId==425||$catId==426||$catId==427||$catId==354||$catId==362||$catId==430||$catId==429||$catId==353||$catId==346||$catId==342||$catId==343||$catId==339||$catId==338||$catId==336||$catId==333||$catId==329||$catId==328||$catId==327||$catId==326||$catId==325||$catId==324||$catId==323||$catId==322||$catId==428||$catId==319||$catId==316||$catId==312||$catId==311||$catId==310||$catId==309||$catId==308||$catId==304||$catId==422||$catId==335||$catId==423)
            {
                //echo "нашли позицию с нужным ИД<br>";
                //обнуляем список новых параметров для каждого айтема
                $param_new=null;
