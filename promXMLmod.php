...
{    
    ...
    */
    ...
    private function addKeyWords($item)
    {
        ...
        {
            $words[]="лубриканты";
            $words[]="смазки лубриканты";
            $words[]="интимная смазка";
            $words[]="интимные гели смазки";
        }
        //Вагинальные шарики
        if ($catId==6)
        {
            $words[]="шарики кегель";
            $words[]="Вагинальные шарики";
            $words[]="секс шоп шарики";
            $words[]="шарики интим";
            $words[]="шарики для влагалища";
        }
        //Пробки, плуги анальные
        if ($catId==7)
        {
            $words[]="анальная пробка";
            $words[]="пробка для секса";
            $words[]="пробки для секса";
            $words[]="пробка в анус";
            $words[]="анальная пробка плаг";
            $words[]="плаг анальный";
            $words[]="пробка для попы";
            $words[]="пробка в анус";
        }
        ...
        {
            $words[]="мастурбатор";// 
            $words[]="искусственные вагины";//
            $words[]="вагина игрушки";//
            $words[]="интимные гели смазки";
        }
        //Помпы вакуумные
        if ($catId==9)
        {
            $words[]="помпы вакуумные";
            $words[]="помпа сексшоп";
            $words[]="секс шоп помпа";
            $words[]="помпа для секса";
        }
        //Вибраторы
        if ($catId==10)
        {
            $words[]="вибратор";
            $words[]="женский вибратор";
            $words[]="вибратор секс";
            $words[]="вибраторы интим";

        }
        //Возбудители
        if ($catId==11)
        {
            $words[]="возбудитель для секса";//возбудитель для секса
            $words[]="возбудитель";//возбудитель
            $words[]="секс шоп возбудитель";//секс шоп возбудитель
            $words[]="секс возбудитель";//секс возбудитель
            $words[]="афродизиак";
        }
        //Духи с феромонами
        if ($catId==12)
        {
            $words[]="духи с феромонами";//духи с феромонами
            $words[]="духи с афродизиаком";//духи с афродизиаком
            $words[]="феромон парфюм";//феромон парфюм
        }
        //Большие королевские размеры
        if ($catId==14)
        {
            $words[]="королевский размер одежда";//королевский размер одежда
            $words[]="большого размера";//большого размера
        }
        //Массажные масла, массажные свечи
        if ($catId==15)
        {
            $words[]="масло массажное";//масло массажное
            $words[]="массажное масло";//массажное масло
            $words[]="олія для масажу";//олія для масажу
            $words[]="олійка для масажу";//олійка для масажу
            $words[]="массажная свеча";//массажная свеча

        }
        //Насадки, кольца
        if ($catId==15)
        {
            $words[]="насадки на член";
            $words[]="насадки на фалос";
            $words[]="насадка на пенис";
            $words[]="эрокционные кольца";
            $words[]="эректильные кольца";
            $words[]="эрективные кольца";
            $words[]="кольцо для ерекции";

        }
        //Платья сексуальные
        if ($catId==263)
        {
            $words[]="прозрачные платье";
            $words[]="эротическое платье";
            $words[]="платье секси";
            $words[]="латье сексуальное";
            $words[]="откровенное платье";
            $words[]="эро платья";
            $words[]="соблазнительные платья";
            $words[]="открытые платья";
        }
        //Вибраторы с пультом
        if ($catId==264)
        {
            $words[]="вибратор с пультом";
            $words[]="вибратор с пультом управления";
            $words[]="вибратор на пульте";
            $words[]="вибратор дистанционный";
            $words[]="вибратор на управлении";
            $words[]="вибратор";
            $words[]="вибраторы для женщин";
            $words[]="дистанционные вибраторы";
        }
        //Наборы анальных игрушек
        if ($catId==113)
        {
            //набор для секса
            //набор секс игрушек
        ...
        if ($catId==19)
        {
            ...
            //пролонгаторы для секса
            //пролонгаторы полового акта
            //пролонгатор
            //
        }
        //Секс-куклы
        if ($catId==20)
        {
            ...
            //секс кукла
            //кукла для секса
            //силиконовые куклы для взрослых
            //силиконовая кукла для секса
            //кукла секс шоп
            //интим куклы
            //резиновая девушка
            //
        ...
        if ($catId==21)
        {
            //фаллопротезы и полые страпоны
            //Страпоны
            //фаллопротез
            //фаллопротез мужской
            //секс шоп фаллопротез
            //мужской фаллопротез
            //сексшоп страпон
            //strapon
        ...
        if ($catId==22)
        {
            //прикольные секс сувениры
            //секс игрушки прикол
            //секс подарки приколы
            //приколы сексшоп
            //сексуальные прикольные подарки
            //сексшоп приколы и подарки
            //интимние приколи подарок
            //секс шоп приколы
        }
        //Женское секси белье
        if ($catId==24)
        {
            //женское нижнее эротическое белье
            //интимное белье женское
            //женское белье секси
            //женское интим белье
            //эротическое белье для девушек
            //эротическое бельё
            //сексуалное белье
        ...
        if ($catId==28)
        {
            //средства для увеличения пениса
        ...
        if ($catId==30)
        {
            //секс игрушки для фистинга
            //Фистинг
            //игрушки для анального фистинга
            //фистинг секс шоп
            //дилдо для фистинга
            //фаллоимитаторы фистинг
        ...
        if ($catId==35)
        {
            //товары для геев
            //игрушки для геев
            //секс товары для геев
        }

        //Медицинский фетиш
        if ($catId==267)
        {
            //секс игрушки медицинский фетиш
            //Медицинский фетиш
            //медицинский фетиш бдсм
            //медицинский секс
            //медфетиш
        ...
        if ($catId==259)
        {
            ...
            //веревки шибари
            //шибари
            //веревки для связывания
            //бондаж веревка
            //сибари
            //японское связывание
            //веревка для связывания бдсм
        }
        //Распорки
        if ($catId==260)
        {
        ...
        if ($catId==44)
        {
            ...
            //массажер простаты
            //стимуляция простаты
            //вибратор для простаты
        }
        //Бусы, елки, шарики анальные
        if ($catId==45)
        {
            //секс игрушки
            //интимные игрушки
        ...
        if ($catId==50)
        {
            //секс игрушки
            //интимные игрушки
            //вибраторы для g точки
            //вибратор стимулирующий точку g
            //вибратор точки g
            //стимулятор точки g
            //вибратор для точки джи
            //вибратор джи
            //вибратор g            
            //вибратор g точки
            //массажер точки g
        ...
        //Духи для женщин с феромонами
        if ($catId==251)
        {
            //духи с феромонами
            //духи с феромоном женские
            //духи з афродизіаками
            //женская парфюмерия с феромонами
            //духи с флюидами
            //духи з афродизиаком
            //духи с феромонами для возбуждения мужчин
            //духи феромоны
        }
        //Духи для мужчин с феромонами
        if ($catId==252)
        {
            //духи с феромонами
        ...
        if ($catId==55)
        {
            ...
            //возбудители для девушек
            //озбудитель для женщины
            //афродизиак для женщин
        }
        //Виброяйца
        if ($catId==272)
        {
            ...
            //вибро яйцо
            //секс шоп виброяйцо
            //яйцо игрушка для взрослых

        }
        //Возбудители для двоих
        if ($catId==59)
        {
            //возбудитель для женщин и мужчин
            //возбуждающие средства
            //препарат возбудитель
            //возбудитель
            //возбудитель для пары
            //
        }
        //Секси комплекты (белье)
        if ($catId==60)
        {
            //комплект белья для секса
            //сексуальные комплекты белья
            //сексуальные комплекты
            //комплект сексуального белья
            //комплект сексуального белья
            //эротическое белье
        ...
        //Пеньюары, сорочки эротические
        if ($catId==62)
        {
            //эротические сорочки пеньюары
            //белье и пеньюары
            //сексуальные пенюары
            //пеньюары эротические
            //сорочки сексуальные
            //сорочки и пеньюары
            //сексуальные сорочки
            //сорочка эротическая
        }
        //Аксессуары к секси костюмам
        if ($catId==138)
        {
            //аксессуары для секса
            //секс шоп аксессуары
            //интим аксессуары
            //аксессуары для интимных игр
        ...
        {
            //фетиш одежда
            //эротическая одежда из латекса
            //интим одежда
            //винил секс шоп
            //секси наряд из латекса
            //одежда из винила
            //эротическая одежда
            //эротическая одежда из латекса
            //эротическая фетиш одежда
            //винил и латекс
        }
        //Трусики секси, стринги
        if ($catId==68)
        {
            //сексуальные женские трусики
            //эротические трусики
            //женские трусики секси
            //трусики сексуальные
            //женские сексуальные трусики
            //сексуальное белье
            //эротическое белье
        }
        //Чулки секси
        ...
        //Аксессуары, наклейки на соски
        if ($catId==70)
        {
            //эротические аксессуары заказать
            //наклейки для сосков
            //сексуальное белье
            //эротическое белье
        }
        ...
        if ($catId==78)
        {
            //электросекс
            //секс электро
            //электростимуляция в сексе
            //электрический секс
            //электрические секс игрушки
            //бдсм электростимулятор
            //электростимуляторы для секса
            //электростимулятор сексшоп
            //электростимуляция бдсм
        ...
        {
            //боди эротические
            //эротические женские боди
            //женские сексуальные боди
            //боди сексуальное
            //эротическое белье
            //сексуальные боди
            //сексуальное белье
        ...
        if ($catId==83)
        {
            ...
            //анальная смазка
            //лубриканты смазки
            //лубрикант для анального секса
            //интимные гели смазки
            //интимная смазка
            //гели для анального секса
        }
        //Вагинальные смазки лубриканты
        if ($catId==84)
        {
            //смазки вагинальные
            //вагинальные лубриканты
            //смазки для вагинального секса
            //лубриканты смазки
            //интимные гели смазки
            //интимная смазка
        }
        //Съедобные смазки лубриканты
        if ($catId==85)
        {
            //смазка съедобная
            //съедобный лубрикант
            //съедобная интимная смазка
            //съедобные смазки
            //интимная гель смазка съедобная
            //эротическая смазка
            //лубриканты смазки
            //интимные гели смазки
            //интимная смазка
        }
        //Возбуждающие смазки лубриканты
        if ($catId==86)
        {
            //смазка интимная возбуждающая
            //лубрикант возбуждающий
            //возбуждающий лубрикант для женщин
            //возбуждающая смазка для секса
            //лубрикант для возбуждения
            //эротическая смазка
            //лубриканты смазки
            //интимные гели смазки
            //интимная смазка
        ...
        if ($catId==87)
        {
            //удлиняющая насадка на член
            //удлиняющая насадка на пенис
            //насадка на член удлиняющая
            //насадка удлиняющая член
            //удленитель для члена
            //насадка удлинитель пениса
            //удлинитель члена
            //насадки на член
            //сексшоп насадки на член
            //секс шоп насадки
        }
        //Эрекционные кольца
        if ($catId==88)
        {
            ...
            //эрогенное кольцо
            //эректильное кольцо
            //секс шоп эрекционные кольца
            //мужские эрекционные кольца
            //эрекционные кольца на член
        }
        //Одежда БДСМ
        if ($catId==89)
        {
        ...
        //Медсестры секси костюм
        if ($catId==92)
        {
            //секси костюм медсестры
            //костюм медсестры секси
            //сексуальный костюм медсестры
            //костюм медсестры
            //игровой костюм медсестры
            //наряд медсестры
            //костюм медсестры взрослый
            //эротический костюм медсестра
            //костюм медсестры эротический
            //медсестра эротические костюмы
            //костюмы для секса


        }
        //Полицейские секси костюмы
        if ($catId==93)
        {
            //интим одежда полицейская
            //полицейски костюм секс шоп
            //эротический костюм полицейского
            //эротический костюм полиции
            //костюм полицейского для ролевых игр
            //полицейская униформа секси
            //костюмы для игр полицейский
            //костюмы для секса

        }
        //Горничные секси костюм
        if ($catId==94)
        {
            //эротический костюм горничной
            //костюмы горничной
            //секс костюм горничной
            //костюм горничная
            //горничная костюм
            //костюм горничной
            //костюм служанки
            //костюм покоївки
            //сексуальный костюм горничной
            //костюм домработницы
            //французская горничная костюм
            //костюм горничной секс шоп
            //игровой костюм горничной
            //эротический костюм служанки
            //наряд горничной
            //костюмы для секса

        }
        //Разные секси костюмы
        if ($catId==95)
        {
            //костюмы для секса
            //костюмы для ролевых игр
        ...
        //Зайчики плейбой секси костюм
        if ($catId==96)
        {
            //плей бой зайчик
            //плейбой зайчик
            //секси зайка
            //костюм кролика плейбой
            //костюм зайчика плейбой
            //костюм playboy
            //зайка плейбой
            //костюм зайки плейбой
            //костюм зайчика из плейбоя
            //костюм плейбой зайчик
            //костюмы для секса
        ...
        if ($catId==97)
        {
            //эротические костюмы сказочных героев
            //костюмы сказочных героев для взрослых
            //костюмы сказочных персонажей для взрослых
            //сказочные герои костюмы для взрослых
            //костюмы для секса

        }
        
        //Снегурочки секси костюм
        if ($catId==99)
        {
            //секси костюм снегурочки
            //костюм снегурочки секси
            //костюм снегурочки взрослый
            //костюмы для секса
            //взрослый красный костюм снегурочки
            //сексуальный костюм снегурочки
            //эротический костюм снегурочки
            //эротический наряд снегурочки
            //костюм снегурочки эротический
            //костюм снегурочки секс шоп
        }
        //Школьница/Учительница секси костюм
        if ($catId==100)
        {
            //эротический костюм школьницы
            //эротический костюм школьница
            //костюм школьницы для взрослых
            //эротические костюмы для взрослых
            //костюмы для ролевых игр
            //костюмы для секса
        }
        //Монашки секси костюм
        if ($catId==101)
        {
            //эротический костюм монашки
            //сексуальный костюм монашки
            //секс шоп костюм монашки
            //костюмы для секса
            //
        }
        //Приколы
        if ($catId==141)
        {
            ...
            //приколы сексшоп
            //приколы секс шоп
            //подарок из сексшопа приколы
            //секс шоп приколы
            //эротические подарки
        }
        //Вагинально-анальные (вибраторы)
        if ($catId==106)
        {
            //вагинально анальный вибратор
            //анально вагинальный фалоимитатор
            //анально вагинальные стимуляторы
            //вибратор с двойной стимуляцией
            //анально вагинальные вибраторы
            //вибратор анально вагинальный
            //вибратор двухсторонний
        }
        //Секс игры
        if ($catId==107)
        {
            //секс настольная игра
            //настольные игры эротические
            //эротические игры купить
            //настольная игра секс
            //эротическая настольная игра
            //интимные настольные игры
            //секс настольные игры
            //эротические игры
            //интимные игры для взрослых
            //игры интимные
            //настольные игры для секса
            //игры для секса
